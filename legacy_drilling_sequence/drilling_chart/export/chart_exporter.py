...
class ChartExporter:
    ...
    @staticmethod
    def export_chart(fig: go.Figure, output_dir: str, df: pd.DataFrame, color_manager: ColorManager) -> None:
        ...
        ChartExporter._export_html_with_legend(fig, output_dir, legend_html, sticky_kpi_html, signature_html, signature_generator)
    ...
    @staticmethod
    def _export_html_with_legend(fig: go.Figure, output_dir: str, legend_html: str, sticky_kpi_html: str = "", signature_html: str = "", signature_generator: SignatureGenerator = None) -> None:
        """Export HTML file with embedded custom legend, signature section, sticky KPI dashboard, and improved scroll behavior"""
...
<head>
    ...
    <title>Drilling Operations Schedule Dashboard</title>
...
<body>
    ...
    <div class="main-container">
        <div class="header-section">
            <h1 class="header-title">🛢️ Drilling Operations Schedule Dashboard</h1>
            <p class="header-subtitle">Comprehensive view of drilling activities, readiness status, and contract management</p>
        </div>
