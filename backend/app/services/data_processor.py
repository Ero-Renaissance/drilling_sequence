...
# The activity-type vocabulary lives in its own pandas-free module (imported by
# the schema validator too); re-exported here so existing importers keep working.
from app.services.activity_types import (  # noqa: F401
    CANONICAL_ACTIVITY_TYPES,
    canonicalize_activity_type,
