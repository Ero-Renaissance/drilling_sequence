...
class AuditLog(Base):
    ...
    # NULL = a GLOBAL governance event (admin/planner-grant changes) — those are
    # not project-scoped, and privilege changes must live in this append-only
    # table, not only in transient process logs.
